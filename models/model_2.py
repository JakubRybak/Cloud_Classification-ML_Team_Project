...
# This model seems to require float32 precision; mixed_float16 may not work.
# Further investigation might be needed to enable mixed precision.
...
# Performance is very poor - needs investigation
# ---------------------------------------------------------------------------------------------------
