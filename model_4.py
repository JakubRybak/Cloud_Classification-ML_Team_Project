...
from keras.applications import DenseNet121  # Changed from EfficientNetB0, MobileNetV2
...
# FOURTH MODEL: DenseNet121
# Using DenseNet121 as the base model for transfer learning
# ---------------------------------------------------------------------------------------------------
...
# Freeze the weights of most DenseNet121 layers for transfer learning
