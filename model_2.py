...
#W tym modelu musi byc normalna precyzja nwm, moze da sie zmienic, nie probowalem
...
# MEGA SLABY dziwne rzeczy sie dzieja
# ---------------------------------------------------------------------------------------------------
...
for layer in base_model.layers[-30:]:  # Odmrożenie ostatnich 20 warstw
